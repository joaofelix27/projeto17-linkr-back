...
import { likePostController, likeRemoveController, likeGetController } from "../controllers/likesController.js";
...
likesRouter.delete("/like/:id", getUserData, alreadyLiked, likeRemoveController);
